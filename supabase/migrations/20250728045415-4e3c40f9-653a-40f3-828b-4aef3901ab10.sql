-- Fix the get_brand_applications function to use campaign_participants instead of campaign_applications
...
BEGIN
    ...
    SELECT 
        ...
        COALESCE(ia.engagement_rate, 0) as engagement_rate,
        0::bigint as average_views,
        COALESCE(p.name, 'General') as niche,
        COALESCE(cp.ai_match_score, 0) as ai_score

...
import { Save, User, Mail, Building, Key } from 'lucide-react';
      ...
      <div className="flex-1 ml-64 overflow-y-auto">
        <div className="p-8 max-w-4xl">
          <div className="mb-8">
            ...
            <p className="text-gray-600">Manage your brand account and preferences</p>
          </div>
